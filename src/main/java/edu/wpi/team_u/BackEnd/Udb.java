...
public class Udb {
  ...
  public static void main(String[] args) throws IOException, SQLException {
    ...
    String csvLocationFile = "edu/wpi/team_u/csvTables/TowerLocations.csv";
    String csvEmployee = "edu/wpi/team_u/csvTables/TowerEmployees.csv";
    String csvEquipment = "edu/wpi/team_u/csvTables/TowerEquipment.csv";
